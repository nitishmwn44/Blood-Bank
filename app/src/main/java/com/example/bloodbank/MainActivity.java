    ...
    private void readDonor() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (userList.isEmpty()) {
                    Toast.makeText(MainActivity.this, "No Donors available", Toast.LENGTH_SHORT).show();
                    progressbar.setVisibility(View.GONE);
                }
            }
    ...
    private void readRecipient() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                progressbar.setVisibility(View.GONE);
                if (userList.isEmpty()) {
                    Toast.makeText(MainActivity.this, "No recipients available", Toast.LENGTH_SHORT).show();
                    progressbar.setVisibility(View.GONE);
                }
            }
